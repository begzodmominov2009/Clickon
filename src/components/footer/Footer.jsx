...
const Footer = () => {
    return (
        <footer className="w-full mb-7 sm:mb-0">
            ...
            <section className="bg-[#1B6392] text-white py-20">
                <div className="container mx-auto px-2 md:px-0 2xl:px-33 text-center">
                    ...
                    <div className="flex justify-center items-center gap-5 sm:gap-10 mt-6 sm:mt-12 opacity-80 flex-wrap">
                        <img className="cursor-pointer" src="/google.svg" alt="Google" />
                        <img className="cursor-pointer" src="/amazon.svg" alt="Amazon" />
                        <img className="cursor-pointer" src="/philips 1.svg" alt="PHILIPS" />
                        <img className="cursor-pointer hidden sm:flex" src="/toshiba-1 1.svg" alt="TOSHIBA" />
                        <img className="cursor-pointer hidden sm:flex" src="/samsung-4 1.svg" alt="Samsung" />
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#111416] text-gray-400 pt-16">
                <div className="container mx-auto px-2 md:px-2 2xl:px-33 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
                    ...
                    <div>
                        <div className="mb-4">
                            <img className="w-[177px] h-[48px]" src="/Logo-footer.svg" alt="logo" />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-4 bg-gray-600/80 px-4 py-1 rounded cursor-pointer">
                                <img src="/app-store.svg" alt="Google Play" />
                                <div>
                                    <p className="text-[14px]">Get it now</p>
